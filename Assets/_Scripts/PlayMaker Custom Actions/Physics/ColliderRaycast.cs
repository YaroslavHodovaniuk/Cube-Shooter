...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class ColliderRaycast : FsmStateAction
	{
		//[ActionSection("Setup Raycast")]

		[RequiredField]
		[Tooltip("The GameObject with the Collider attached")]
		public FsmGameObject colliderGameObject;
		...
		{
			coll = colliderGameObject.Value.GetComponent<Collider>();
			DoRaycast();
        ...
        private void DoRaycast()
		{
			...
			Ray penRay = new Ray(originPos, dirVector);
			RaycastHit hitInfo;
			coll.Raycast(penRay, out hitInfo, 1000);
