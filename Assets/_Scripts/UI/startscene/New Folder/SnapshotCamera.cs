...
#pragma warning restore 0649
    ...
    /// </summary>
    public Vector3 defaultPositionOffset = new Vector3(0, 0, 0.5f);
    /// <summary>
    ...
    /// <param name="name">The name that will be given to the new GameObject the SnapshotCamera will be attached to.</param>
    /// <returns>A new SnapshotCamera, ready for use.</returns>
    public static SnapshotCamera MakeSnapshotCamera(int layer = 8, string name = "Snapshot Camera")
    {
        if (layer < 0 || layer > 31)
    ...
    public static FileInfo SavePNG(byte[] bytes, string filename = "", string directory = "Assets/Resources/Weapon")
    {
        ...
        {
            directory = Directory.CreateDirectory(directory != "" ? directory : Path.Combine(Application.dataPath, "../Snapshots")).FullName;
        }
    ...
    /// <param name="directory">The directory in which to save the file. This will be the game/Snapshots directory if not specified.</param>
    /// <returns>A FileInfo pointing to the created PNG file</returns>
    public static FileInfo SavePNG(Texture2D tex, string filename = "", string directory = "Assets/Recources/Weapon")
    {
    ...
    public Texture2D TakeObjectSnapshot(GameObject gameObject, int width = 256, int height = 256)
    {
    ...
    /// <param name="height">The height of the snapshot image.</param>
    /// <returns>A Texture2D containing the captured snapshot.</returns>
    public Texture2D TakeObjectSnapshot(GameObject gameObject, Color backgroundColor, int width = 256, int height = 256)
    {
    ...
    /// <param name="height">The height of the snapshot image.</param>
    /// <returns>A Texture2D containing the captured snapshot.</returns>
    public Texture2D TakeObjectSnapshot(GameObject gameObject, Vector3 positionOffset, Quaternion rotation, Vector3 scale, int width = 256, int height = 256)
    {
    ...
    /// <param name="height">The height of the snapshot image.</param>
    /// <returns>A Texture2D containing the captured snapshot.</returns>
    public Texture2D TakeObjectSnapshot(GameObject gameObject, Color backgroundColor, Vector3 positionOffset, Quaternion rotation, Vector3 scale, int width = 256, int height = 256)
    {
        if (gameObject == null)
    ...
    /// <param name="height">The height of the snapshot image.</param>
    /// <returns>A Texture2D containing the captured snapshot.</returns>
    public Texture2D TakePrefabSnapshot(GameObject prefab, int width = 256, int height = 256)
    {
    ...
    /// <param name="height">The height of the snapshot image.</param>
    /// <returns>A Texture2D containing the captured snapshot.</returns>
    public Texture2D TakePrefabSnapshot(GameObject prefab, Color backgroundColor, int width = 256, int height = 256)
    {
    ...
    /// <param name="height">The height of the snapshot image.</param>
    /// <returns>A Texture2D containing the captured snapshot.</returns>
    public Texture2D TakePrefabSnapshot(GameObject prefab, Vector3 positionOffset, Quaternion rotation, Vector3 scale, int width = 256, int height = 256)
    {
    ...
    /// <param name="height">The height of the snapshot image.</param>
    /// <returns>A Texture2D containing the captured snapshot.</returns>
    public Texture2D TakePrefabSnapshot(GameObject prefab, Color backgroundColor, Vector3 positionOffset, Quaternion rotation, Vector3 scale, int width = 256, int height = 256)
    {
        if (prefab == null)
